  ...
  return (
    <PageTransition>
      <Routes>
        ...
        <Route path="/products/crash-barriers" element={<CrashBarriers />} />
        <Route
          path="/products/roofing-solutions"
          element={<RoofingSolutions />}
        />
        <Route path="/railway-projects" element={<RailwayProjects />} />
        <Route
